...
//********************************************************************************************
  if (micros() - lastdsm0 >= dsm0)
  {
    ...
    if (redrand0 == redrand00)
    {
      ...
      {
      lastds0 = millis();
        strip.setPixelColor(0, red0, yellow0, 5);
        strip.setPixelColor(1, red0, yellow0, 5);
        strip.show();
        ds0 = random(50, 300);
        //delay(random(3, 200));
...
//********************************************************************************************
  if (micros() - lastdsm1 >= dsm1)
  {
    ...
    if (redrand1 == redrand11)
    {
      ...
      {
      lastds1 = millis();
        strip.setPixelColor(2, red1, yellow1, 0);
        strip.setPixelColor(3, red1, yellow1, 0);
        strip.show();
        ds1 = random(50, 300);
        //delay(random(3, 200));
...
//********************************************************************************************
  if (micros() - lastdsm2 >= dsm2)
  {
    ...
    if (redrand2 == redrand22)
    {
      ...
      {
      lastds2 = millis();
        strip.setPixelColor(4, red2, yellow2, 0);
        strip.setPixelColor(5, red2, yellow2, 0);
        strip.show();
        ds2 = random(50, 300);
        //delay(random(3, 200));
...
//********************************************************************************************
  if (micros() - lastdsm3 >= dsm3)
  {
    ...
    if (redrand3 == redrand33)
    {
      ...
      {
      lastds3 = millis();
        strip.setPixelColor(6, red3, yellow3, 0);
        strip.setPixelColor(7, red3, yellow3, 0);
        strip.show();
        ds3 = random(50, 300);
        //delay(random(3, 200));
...
//********************************************************************************************
  if (micros() - lastdsm4 >= dsm4)
  {
    ...
    if (redrand4 == redrand44)
    {
      ...
      {
      lastds4 = millis();
        strip.setPixelColor(8, red4, yellow4, 0);
        strip.setPixelColor(9, red4, yellow4, 0);
        strip.show();
        ds4 = random(50, 300);
        //delay(random(3, 200));
